...
1. 이 프로젝트를 다운로드 합니다다. (압축 해제 하지 말 것)
...
| 폐급 | 5.1% ~ 29.9% | 5.1% ~ 29.9% | 2점 | #CCCCCC |
| 불량 | 0.0% ~ 5.0% | 0.0% ~ 5.0% | 1점 | #BBBBBB |
...
| 태그 | 조건 | 점수 | 색상 |
|------|------|------|------|
| 완전무결 | 위력+무게 합산 16점 또는 한쪽 범위좁음+다른쪽 무결 | - | #00FFF0 |
| 종결 | 위력+무게 합산 12 ~ 15점 또는 한쪽 범위좁음+다른쪽 6~7점 | - | #FF5555 |
| 준종결 | 위력+무게 합산 11점 또는 한쪽 범위좁음+다른쪽 5점 | - | #C770FF |

**범위좁음 조건**: 위력 또는 무게의 범위가 9 이하인 경우

> **참고**:
> - 범위좁음인 경우 점수 계산 방식이 변경됨
