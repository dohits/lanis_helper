...
- 릴리즈 파일 다운로드 링크 
- 1.5.2 : https://github.com/user-attachments/files/21381210/lanis_helper_1.5.2.zip
...
![어빌리티 정보 모달 예시](img/ability_info.png)
- 어빌리티명/효과 검색, 직업별 토글, 실시간 구글 시트 연동

### 장비 해방 정보 예시

![장비 해방 정보 모달 예시](img/enchant_info.png)
- 구글 시트에서 실시간으로 해방 정보 데이터를 가져와 테이블 형태로 표시
- 동/은/금/칠색 등급별 해방 수치 정보 제공

### 프로그램 정보 예시

![프로그램 정보 모달 예시](img/program_info.png)
