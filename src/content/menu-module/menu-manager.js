...
import ImageUploadModal from './modal/board/image-upload-modal.js';
...
class MenuManager {
  constructor() {
    ...
    this.specCalculatorModal = new SpecCalculatorModal();
    ...
    this.artifactEnchantSimModal = new ArtifactEnchantSimModal();
