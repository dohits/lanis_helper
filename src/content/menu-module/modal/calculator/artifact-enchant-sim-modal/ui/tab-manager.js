...
class TabManager {
  ...
  createTabSection(onSwitch) {
    ...
    const tabs = [
      { id: 'artifact-tab1', text: '시뮬레이터', active: true },
      { id: 'artifact-tab2', text: '기댓값', active: false }
    ];
  ...
  switchTab(tabId) {
    const buttons = document.querySelectorAll('#artifact-tab1, #artifact-tab2');
    buttons.forEach(btn => {
