...
### 확장 프로그램 컨텍스트 오류 메시지 일관성 개선
- `Extension context invalidated` 오류 메시지를 기존 메시지와 일관되게 수정
- "확장 프로그램을 새로고침해주세요" → "페이지 새로고침 후 다시 시도해주세요"
- 모든 오류 처리 위치에서 일관된 메시지 사용
- 사용자 친화적인 오류 안내 메시지 제공
